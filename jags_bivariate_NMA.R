...
model{
  ...
  # for (i in 1:(Ns-N2h)){
  #   S[i,1,1]<- var1[N2h+2*i-1]+psiR.sq
  #   
  #   S[i,2,2]<-var2[N2h+2*i-1]+psiD.sq
  #   
  #   S[i,3,3]<- var1[N2h+2*i]+psiR.sq
  #   
  #   S[i,4,4]<-var2[N2h+2*i]+psiD.sq
  # 
  ...
  #   SUCRA2[k]< - sum(cumeffectiveness2[k,1:( NT-1)]) /(NT-1)}}
   ...
   con="bivariate_NMA_2arm.txt"
    )


modfile="bivariate_NMA_2arm.txt"
